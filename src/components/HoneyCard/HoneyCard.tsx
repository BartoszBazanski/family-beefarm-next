...
export const HoneyCard = ({ imageSrc, title, linkHref }: HoneyCardProps) => {
  return (
    <article className="shadow-secondary-900 border-secondary-500 hover:shadow-secondary-500 grid overflow-hidden rounded-xl border-2 shadow hover:shadow-lg">
      <div
      ...
      >
        <Image src={imageSrc} alt={title} className="object-cover" layout="fill" priority />
      </div>
